	...
	<body>
		...
		<div id="show-content" class="content scaffold-show" role="main">
			...
			<ol class="property-list content">
				...
				<g:if test="${contentInstance?.lastEdited}">
				<li class="fieldcontain">
					<span id="lastEdited-label" class="property-label"><g:message code="content.lastEdited.label" default="Last Edited" /></span>
					
						<span class="property-value" aria-labelledby="lastEdited-label"><g:formatDate date="${contentInstance?.lastEdited}" /></span>
				...
				<g:if test="${contentInstance?.imageUrl}">
				<li class="fieldcontain">
					<span id="imageUrl-label" class="property-label"><g:message code="content.imageUrl.label" default="Image Url" /></span>
					
						<span class="property-value" aria-labelledby="imageUrl-label"><g:fieldValue bean="${contentInstance}" field="imageUrl"/></span>
