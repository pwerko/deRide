 ...
 */
class ZipCodeConstraint extends AbstractConstraint {

    private static final String DEFAULT_MESSAGE_CODE = "default.zipCode.invalid.message";
    public static final String NAME = "zipCode";
